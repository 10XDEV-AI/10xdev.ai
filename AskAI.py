...
def filter_functions(result_string, filepaths, email, userlogger, history):
    if history:
        ...
        system_message = "You will be provided with [1] A list of file paths, their roles and summaries delimited by triple quotes and [2] a chat between AI and Human User delimited XML tags. "
