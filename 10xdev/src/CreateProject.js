...
function CreateProject() {
  ...
  return (
    ...
    <p class="mb-6 p-1 text-lg font-normal text-gray-500 lg:text-xl ">Describe your project. AI will ask clarifying questions next</p>
        <form onSubmit={handleSubmit}>
           <div class="w-full mb-4  border border-gray-200 rounded-lg bg-gray-50 ">
               <div class="px-4 py-2 bg-white rounded-t-lg ">
                   <label for="comment" class="sr-only">Your Project</label>
                   <textarea onChange={handlePromptChange} id="comment" rows="4" class="w-full px-0 text-sm text-gray-900 bg-white border-0 focus:ring-0 " placeholder="Describe your goal..." required></textarea>
               </div>
         ...
         <h1 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-4xl ">Clarifying Questions:</h1>
          ...
          {clarifyingQuestions}
            ...
            <form className="mx-4 ">
               <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 ">
                   <div class="px-4 py-2 bg-white rounded-t-lg ">
                       <label for="comment" class="sr-only">Your Answers</label>
                       <textarea
