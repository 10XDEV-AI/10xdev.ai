            ...
            <div className="w-full">
              ...
              {chatMessages.map((chatMessage, index) => (
                ...
                <div className="px-[15%] p-10">
                    <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 ">Your Project is ready!</h1>
                    <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl ">Add this Project to Github first and then to 10XDEV.AI to add more features</p>
                    <a onClick={handleDownload} className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                        Download Zip File
